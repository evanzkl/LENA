...
class TranslatorApp(tk.Tk):
    def __init__(self, camera_index: int | None = None) -> None:
        ...
        window_w = min(_REFERENCE_SIZE[0], screen_w - 80)
        window_h = min(_REFERENCE_SIZE[1], screen_h - 100)
        ...
        self._ui_events: Queue[tuple[Any, ...]] = Queue()
        self._ui_event_job = self.after(25, self._drain_ui_events)
    ...
    def _post_ui_event(self, callback, *args: Any) -> None:
    ...
    def _connect_camera_worker(self, camera_index: int | None) -> None:
        try:
            ...
            self._post_ui_event(self._on_camera_error, str(exc))
            return
        self._post_ui_event(self._on_camera_ready, camera, camera_index)
    ...
    def _reconnect_probe_worker(self) -> None:
        ...
        try:
            ...
            camera = None
            camera_index = None
        self._post_ui_event(self._on_reconnect_probe_done, camera, camera_index)
